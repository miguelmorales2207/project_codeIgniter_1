...
$sql = $db->query("SELECT placa, tipo, marca, modelo, estado, precio, id_user FROM coches WHERE id_user='$user';"); 
...
if ($db->rows($sql) > 0) {                    
    ...
    echo "<th><center>Modelo</center></th>";
    ...
    echo "<p>El usuario ingresado no existe...</p>";
}
